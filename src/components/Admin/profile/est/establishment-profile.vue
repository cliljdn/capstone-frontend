<template>
	<div class="">
		<div class="modal" :class="{ 'is-active': this.$store.state.openModalEst }">
			...
			<div class="modal-card">
				...
				<section class="modal-card-body">
										...
										<div class="column">
											...
											<div class="columns">
												<div class="column">
													<span class="icon is-small is-left level">
														<i class="fas fa-address-card"></i>
														<span class="account-type ml-2">Lastname: </span>
										...
										<div class="column address-info">
											<div class="columns">
												<div class="column">
													<span class="icon is-small  is-left level">
														<i class="fas fa-address-card"></i>
														<span class="admin ml-2">Address:</span>

														<p class="address-field">
															<span class="admin ml-2"
																>Blk 7 Lot 16 Stamonica</span
															>
														</p>
													</span>
												</div>
											...
											<div class="columns">
												<div class="column">
													<span class="icon is-small is-left level">
														<i class="fas fa-address-card"></i>
														<span class="admin ml-2">Barangay: </span>
														<span class="admin ml-2">Sto.thomas</span>
													</span>
												</div>
											</div>
											...
											<div class="columns">
												<div class="column">
													<span class="icon is-small is-left level">
														<i class="fas fa-address-card"></i>
														<span class="account-type ml-2">City: </span>
														<span class="admin ml-2">Olongapo City</span>
													</span>
												</div>
											</div>
										</div>
					...
					<div class="columns">
						<div class="column">
							<div class="tabs is-centered">
								<ul>
									<li :class="{ 'is-active': isTabActivePerson }">
										<a @click="showCitizenEntered">
									...
									<li :class="{ 'is-active': isTabActiveEmp }">
										<a @click="showEmpForm">
											<span class="icon is-small"
					...
					<div class="" v-if="isTabActivePerson">
						<EnteredEst />
					</div>

					<div class="" v-if="isTabActiveEmp">
						<EstEmployees />
					</div>
				</section>
